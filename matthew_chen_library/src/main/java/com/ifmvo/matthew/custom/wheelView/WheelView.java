...
public class WheelView extends View {
     ...
     */
    private static final int VALUE_TEXT_COLOR = 0xF0323232;
...
//			0x00AAAAAA, 0x00AAAAAA };
    ...
    private void initData(Context context) {
        ...
        TEXT_SIZE = ViewUtil.dip2px(context, TEXT_SIZE);
        ITEMS_TEXT_SIZE = ViewUtil.dip2px(context, ITEMS_TEXT_SIZE);
