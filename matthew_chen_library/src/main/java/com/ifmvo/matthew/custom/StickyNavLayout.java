    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                } else if (mInnerScrollView instanceof RefreshRecyclerView) {
                    RefreshRecyclerView lv = (RefreshRecyclerView) mInnerScrollView;
                    View c = null;
                    if (lv.getLayoutManager() instanceof LinearLayoutManager) {
                        c = lv.getLayoutManager().findViewByPosition(((LinearLayoutManager) lv.getLayoutManager()).findFirstVisibleItemPosition());
                    } else if (lv.getLayoutManager() instanceof GridLayoutManager) {
                        c = lv.getLayoutManager().findViewByPosition(((GridLayoutManager) lv.getLayoutManager()).findFirstVisibleItemPosition());
                    } else if (lv.getLayoutManager() instanceof StaggeredGridLayoutManager) {
                        int[] firstVisibleItems = null;
                        firstVisibleItems = ((StaggeredGridLayoutManager) lv.getLayoutManager()).findFirstVisibleItemPositions(firstVisibleItems);
                        c = lv.getLayoutManager().findViewByPosition(firstVisibleItems[0]);
                    }
                    if (c != null)
                        if (!isInControl && c != null && c.getTop() == 0 && isTopHidden && dy > 0) {
                            isInControl = true;
                ...
                if (Math.abs(dy) > mTouchSlop) {
                    ...
                    if (mInnerScrollView instanceof ScrollView) {
                        ...
                        if (lv.getLayoutManager() instanceof LinearLayoutManager) {
                            ...
                            c = lv.getLayoutManager().findViewByPosition(0);
                        }
                        if (!isTopHidden ||
                                (c != null &&
                                        c.getTop() == 0 &&
